...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, BookingCreatedEvent> bookingConsumerFactory() {
        ...
        // Configure JsonDeserializer explicitly for BookingCreatedEvent
        JsonDeserializer<BookingCreatedEvent> jsonDeserializer =
                new JsonDeserializer<>(BookingCreatedEvent.class, false);
        jsonDeserializer.addTrustedPackages("com.example.event_service.event");
